...
# R coding tips: categorical variables and interactio terms
...
```{r eval = F}
feols(salary ~ female + pubindx + i(university, ref = "Indiana U") + `i(university, totpge, ref = "Indiana U")`, data = big9salary_c) %>%
  tidy()
```

```{r echo = F, highlight.output = c(14)}
feols(salary ~ female + pubindx + i(university, ref = "Indiana U") + i(university, pubindx, ref = "Indiana U"), data = big9salary_c) %>%
  tidy()
```
