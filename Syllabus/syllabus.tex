...
\caltextnext{Further Issues}
\caltextnext{Endogeneity}
...
\caltextnext{Proposal presentation}
\caltextnext{Panel data methods}
...
\caltextnext{Instrumental variable estimation}
...
%---  ---%
\caltextnext{Limited dependent variable}
\caltextnext{Miscellaneous and uncovered topics}
...
% Holidays
%--------------------------
\Holiday{11/26/2020}{\textcolor{red}{Thanksgiving break: No class}}
\Holiday{11/27/2020}{\textcolor{red}{Thanksgiving break: No class}}
\Holiday{11/28/2020}{\textcolor{red}{Thanksgiving break: No class}}
