...
+ Lectures (MW), 3:00-4:30pm: by me
+ Lab sessions (F), 1:00-2:30pm: led by me and Shunkei
...
+ You learn how to compile your assignment with your R code written in a document using \textcolor{red}{Rmarkdown}, which will be covered in the second lab session
...
+ However, you are simply doing dis-service to yourself by depriving yourself of learning opporunities
...
In this assignment,
  ...
  + you need to ensure that you use a \textcolor{red}{panel} dataset
...
Here is the time line of the paper assignment:
  + \textcolor{blue}{March, 19}: identify a research topic and the data set you will be using, and get an approval from the instructor
  + \textcolor{blue}{March, 26}: paper proposal
  + \textcolor{blue}{May, 13}: final paper 
...
wage <- readRDS('~/Box/Teaching/UNL/AppliedEconometrics_MS/Data/wage1.rds') %>% data.table()
...
<<crime, echo=FALSE>>=
crime <- readRDS('~/Box/Teaching/UNL/AppliedEconometrics_MS/Data/crime4.rds')
crime[,.(county,year,crmrte,prbarr,prbpris)]
@
\end{frame}
